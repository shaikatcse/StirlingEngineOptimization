...
import jmetal.problems.singleObjective.StrilingEngineHeatExchangerDesignProblemReal;
    ...
    if (args.length == 1) {
     ...
     // problem = new Kursawe("Real", 3); 
      ...
      //problem = new OKA2("Real") ;
    	problem = new StrilingEngineHeatExchangerDesignProblemReal("Real", proxy);
    } // else

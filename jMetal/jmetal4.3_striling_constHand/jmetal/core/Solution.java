...
import jmetal.core.SolutionStrilingEngineHeatExchengerProblem;
/**
 * Class representing a solution for a problem.
 */
public class Solution extends SolutionStrilingEngineHeatExchengerProblem implements Serializable {  
	/**
	 * Stores the problem 
	 */
	Problem problem_ ;

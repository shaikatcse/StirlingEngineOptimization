...
import jmetal.problems.singleObjective.FinDesignProblem;;
...
public class ES_main {
  ...
  public static void main(String [] args) throws JMException,
    ...
    problem = new FinDesignProblem FinDesignProblemBinaryReal("BinaryReal");
    ...
    /* Algorithm params*/
    algorithm.setInputParameter("maxEvaluations", 70000);
    
    /* Mutation and Crossover for Real codification */
    parameters = new HashMap() ;
    parameters.put("probability", 1.0/problem.getNumberOfVariables()) ;
   //parameters.put("perturbation", 0.001);
